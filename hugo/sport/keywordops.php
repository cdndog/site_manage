...
$table_name = 'keywordmonitorlist';
$output_name = 'keyword_monitor_list.txt';
...
<form action="<?php echo $_SERVER['PHP_SELF'];?>" method="post" id="formtable" class="needs-validation">
    <div class="form-group">
        <div class="row">
            ...
            <label for="post_gitname">监控关键词</label>
            <input type="text" class="form-control form-control-sm" id="post_keyword" name="post_keyword" value="" required placeholder="录入需要批量监控的关键词">
            <div class="invalid-feedback"> 录入需要批量监控的关键词 </div>
            </div>
      ...
      <div class="row">
        ...
        <div class="col-md-3 col-xs-12">
          ...
          <select data-show-subtext="true" data-live-search="true" class="selectpicker form-control form-control-sm" id="post_geo" name="post_geo" required>
            ...
            <?php endforeach; ?>
<!--             <option value="US" selected>en-US</option>
            <option value="JP">ja-JP</option>
            <option value="CN">zh-CN</option>
            <option value="MX">es-MX</option>
            <option value="KR">ko-KR</option>
            <option value="AR">ar-AR</option>
            <option value="RU">ru-RU</option>
            <option value="FR">fr-FR</option>
            <option value="BR">pt-BR</option>
            <option value="BD">bn-BD</option>
            <option value="PK">ur-PK</option>
            <option value="DE">de-DE</option>
            <option value="SE">sv-SE</option>
            <option value="VN">vi-VN</option>
