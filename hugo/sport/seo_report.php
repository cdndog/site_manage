      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav">
            ...
            <!--</li>          -->
            <li class="nav-item">
              <a class="nav-link" href="addleagues.php">新增关键词</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="seo_report.php?reporttype=sitelist">所有站点</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="siteops.php">新增站点</a>
            </li>
            <!-- <li class="nav-item">
...
function getSeoRelateWordData ($logfile) {
    ...
    // var_dump($loginlog);
    $output = array();
    $tableTitle = array('createtime','lang','mainword','subword');
...
function getSeoAllKeywordData ($logfile) {
    $tableData = file($logfile);
    // var_dump($loginlog);
    $output = array();
...
if (!empty($_GET['reporttype'])) {
    ...
    switch ($report) {
      case 'relateword':
        $headerTitle = array('createtime','lang','mainword','subword');
      ...
      case 'leagueslist':
        $reportData = getSeoAllKeywordData('leagues_monitor_list.txt');
        $sortCol = 'createtime';
        break;
