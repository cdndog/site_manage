<div class="container app-page" id="main">
  <div class="card card-sops">
    <div class="card-header d-flex justify-content-between align-items-center flex-wrap">
      <h1 class="h5 mb-0 page-title"><i class="bi bi-check2-circle mr-2" aria-hidden="true"></i>话题提交确认</h1>
    ...
    <div class="card-body">
        <div class="form-group">
            <div class="row">
                ...
                <label for="post_keyword">话题关键词:</label>
        ...
        <div class="form-group">
          <div class="row">
            <div class="col-md-3 col-xs-12">
                ...
                <input type="text" class="form-control form-control-sm" id="post_domain" name="post_domain" value="<?php echo e($records[0]['domain'] ?? ''); ?>" readonly>
            </div>
            <div class="col-md-3 col-xs-12">
        ...
        <hr>
        <h6 class="page-title"><i class="bi bi-table mr-1" aria-hidden="true"></i>该站点话题列表</h6>
        <div id="displaytable">
        <table
            data-toggle="table"
        ...
        <a class="btn btn-sm btn-secondary mt-3" href="topicops.php"><i class="bi bi-plus-circle mr-1" aria-hidden="true"></i>继续新增</a>
    </div>
  </div>
</div>