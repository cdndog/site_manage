...
<form action="<?php echo e(isset($_SERVER['PHP_SELF']) ? $_SERVER['PHP_SELF'] : '/siteops.php');?>" method="post" id="wechatpost" autocomplete="off">
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control d-none" id="post_uuid" name="post_uuid" value="<?php echo e($form['post_uuid']);?>" readonly>
        <div class="row">
            ...
            <input type="text" class="form-control" id="post_domain" name="post_domain" value="<?php echo e($form['post_domain']); ?>" required placeholder="abc.com 或 ja.abc.com" pattern="[a-z0-9\-]+(\.[a-z0-9\-]+)+" maxlength="63" data-msg="域名格式不正确，如 abc.com 或 ja.abc.com，不要加 https">
            </div>
        </div>
        <div class="sops-label-row">
        ...
        <input type="text" class="form-control" id="post_sitetitle" name="post_sitetitle" value="<?php echo e(htmlspecialchars_decode(strip_tags($form['post_sitetitle']))); ?>" required placeholder="站点标题" pattern="[^|｜]*" maxlength="100" data-msg="站点标题不能包含 ｜，且不超过 100 字">
        ...
        <input type="text" class="form-control" id="post_description" name="post_description" value="<?php echo e(htmlspecialchars_decode(strip_tags($form['post_description']))); ?>" required placeholder="站点描述" pattern="[^|｜]*" maxlength="200" data-msg="站点描述不能包含 ｜，且不超过 200 字">
        ...
        <div class="input-group">
          <input 
            ...
            pattern="https?://\S+"
            maxlength="500"
            data-msg="参考图片需为 https:// 图床链接"
          >
          <div class="input-group-append">
            <!-- Hidden file input -->
            <input type="file" id="imageFileInput" accept="image/*" class="d-none" />
            <button class="btn btn-outline-primary" type="button" id="previewImageTrigger"><i class="bi bi-eye mr-1" aria-hidden="true"></i>预览</button>
            <button class="btn btn-primary" type="button" id="imagesource"><i class="bi bi-upload mr-1" aria-hidden="true"></i>上传</button>
          </div>
        </div>
        ...
        <div class="row">
            ...
            <input type="text" class="form-control" id="post_sns_id" name="post_sns_id" value="<?php echo e($form['post_sns_id']);?>" required placeholder="Facebook" pattern="[^|｜]*" maxlength="50" data-msg="SNS ID 不能包含 ｜">
            </div>
            <div class="col-md-4 col-12">
            <div class="sops-label-row">
            ...
            <input type="text" class="form-control" id="post_topnavmenus" name="post_topnavmenus" value="<?php echo e($form['post_topnavmenus']);?>" required placeholder="首页, 关于" pattern="[^|｜]*" maxlength="200" data-msg="顶部菜单项不能包含 ｜">
            </div>
            <div class="col-md-4 col-12">
            <div class="sops-label-row">
            ...
            <input type="text" class="form-control" id="post_keyword" name="post_keyword" value="<?php echo e($form['post_keyword']);?>" required placeholder="关键词1, 关键词2" pattern="[^|｜]*" maxlength="500" data-msg="SEO关键词不能包含 ｜">
            </div>
        </div>
    </div>
    ...
    <div class="form-group">
      <div class="row">
        ...
        <div class="col-md-3 col-12">
          ...
          <select data-show-subtext="true" data-live-search="true" class="selectpicker form-control" id="post_sitetype" name="post_sitetype">
...
<script>
    ...
    (function () {
        var fields = document.querySelectorAll('[data-msg]');
